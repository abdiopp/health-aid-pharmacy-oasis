      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        <div className="max-w-xl">
          ...
          <p className="text-lg mb-8">
            Get your medications delivered straight to your door with MediCart.
  ...
  return (
    <section className="py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-pharmacy-text">
          Why Choose MediCart?
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-pharmacy-gray text-center">
          ...
          <p className="text-muted-foreground">
            Quick and simple way to order your medications online from anywhere.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-pharmacy-gray text-center">
          ...
          <p className="text-muted-foreground">
            Get answers to your medical questions with our AI chatbot assistant.
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="py-12">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Our most popular medications and supplements
        </p>
      </div>
      ...
      <div className="text-center">
        <Link to="/products">
          <Button
            variant="outline"
            className="border-pharmacy-blue text-pharmacy-blue hover:bg-pharmacy-blue hover:text-white"
          >
            View All Products
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
